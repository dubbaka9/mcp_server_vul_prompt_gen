...
# Import the enhanced LangChain generator
from langchain_prompt_generator import LangChainFortifyPromptGenerator

app = FastAPI(
    title="Vulnerability Prompt Generator API",
    description="Enhanced vulnerability prompt generation using LangChain",
    version="1.0.0"
)
